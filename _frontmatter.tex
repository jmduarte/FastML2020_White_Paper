...
\def\Authors{
Editors: \textnormal{Allison McCarn Deiana\,$^{1}$ (coordinator), Nhan Tran\,$^{2,3}$ (coordinator), 
Joshua Agar\,$^{4}$,
Michaela Blott\,$^{5}$
...
$^{15}$ Thomas Jefferson National Accelerator Facility, Newport News, VA, USA\\
...
$^{23}$ University of California San Diego, La Jolla CA, XXXX, USA\\
$^{24}$ University of Washington, Seattle WA, XXXX, USA\\
$^{25}$ Purdue University, West Lafayette IN, XXXX, USA\\
$^{26}$ University of Illinois Urbana-Champaign, Champaign IL, XXXX, USA\\
}
...
% \textbf{Editors}: \author[1]{Allison McCarn Deiana}, \author[2]{Nhan Tran}
% \textbf{Section Editors}: 
% \author[1]{Joshua Agar},
% \author[1]{Javier Duarte}, 
% \author[1]{Mark Neubauer}, 
% \author[2]{Jennifer Ngadiuba}, 
